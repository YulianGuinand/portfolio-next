    ...
    <div className="sample-project-page">
      ...
      <section className="project-banner-img">
        <div className="project-banner-img-wrapper">
          <img src="/project/associations-manager/am-project-1.png" alt="" />
        </div>
      </section>
      ...
      <section className="project-images">
        <div className="project-images-container">
          ...
          <div className="project-img">
            <div className="project-img-wrapper">
              <img
                src="/project/associations-manager/am-project-4.png"
                alt=""
              />
            </div>
          </div>
          ...
          {/* <div className="project-img">
            <div className="project-img-wrapper">
              <img
                src="/project/associations-manager/am-project-5.png"
                alt=""
              />
            </div>
          </div>
          ...
          <div className="project-img">
            <div className="project-img-wrapper">
              <img
                src="/project/associations-manager/am-project-6.png"
                alt=""
              />
            </div>
          </div> */}
      ...
      <section className="project-details">
        <Copy animateOnScroll={true}>
          <div className="details">
            ...
            <h3>
              Mélanie Troutier & Théo Valadoux & Mathis Mollier & Yulian Guinand
            </h3>
          </div>

          <div className="details">
            <p>Interface</p>
            <h3>Laravel + React / WPF avec Mahapps Metro</h3>
          </div>

          <div className="details">
            <p>Production</p>
            <h3>Fullstack C# / PHP</h3>
          </div>
      ...
      <section>
        <a href="/competia" className="next-project">
          <Copy animateOnScroll={true}>
            <p style={{ marginBottom: "1rem" }}>05 - 06</p>
            <h2>Suivant</h2>
          </Copy>
          ...
          <div className="next-project-img">
            <div className="next-project-img-wrapper">
              <img
                src="/project/associations-manager/next-project.jpg"
                alt=""
              />
            </div>
          </div>
