          ...
          <div className="hero-content-main">
            <div className="hero-header">
              <Copy animateOnScroll={false} delay={isInitialLoad ? 5.75 : 0.75}>
                <h1>Développement Web & Solutions Digitales</h1>
              </Copy>
            </div>
            ...
            <div className="hero-footer">
              <Copy animateOnScroll={false} delay={isInitialLoad ? 6.05 : 1.15}>
                <p className="lg">
                  Je conçois des architectures solides et des interfaces
                  réactives. Étudiant en BTS SIO et alternant passionné par le
                  code propre.
                </p>
              </Copy>
        ...
        <div className="container">
          <div className="featured-work-header-content">
            ...
            <div className="featured-work-header-copy">
              <Copy animateOnScroll={true} delay={0.25}>
                <p className="lg">
                  De l&apos;intégration frontend à la logique backend complexe.
                  Une sélection de travaux réalisés en projets personnels et en
                  formation.
                </p>
              </Copy>
            </div>
        ...
        <div className="container">
          <div className="client-reviews-header-content">
            ...
            <div className="client-reviews-header-copy">
              <Copy animateOnScroll={true} delay={0.25}>
                <p className="lg">
                  Feedback de mes tuteurs, professeurs et collaborateurs sur mon
                  évolution technique.
                </p>
              </Copy>
            </div>
